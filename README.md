...
📊 [**View the Power BI Dashboard**](dashboard/instacart_dashboard.pbix) · 📄 [**Read the Full Insights Report**](docs/Insights_and_Recommendations.docx) · 📋 [**Business Requirements**](docs/01_business_requirements.md) · 💼 [**LinkedIn**](https://www.linkedin.com/in/ayaan-gavandi-a16202218/) · 💻 [**GitHub**](https://github.com/ayaangavandi)
...
[**Open the Power BI Dashboard (.pbix)**](dashboard/instacart_dashboard.pbix)
...
8. Open `dashboard/instacart_dashboard.pbix` in Power BI Desktop, or rebuild the report using `docs/04_powerbi_build_guide.md`
